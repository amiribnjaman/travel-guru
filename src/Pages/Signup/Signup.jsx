    ...
    return (
        <div className='bg'>
            ...
            <form className='mx-auto bg-white max-w-sm px-10 py-10 rounded-lg'>
                ...
                <div class="mx-auto relative z-0 mb-6 w-full group">
                ...
                <button type="submit" class="mx-auto text-white px-10 bg-[#F9A51A] hover:bg-[#ea940a] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
                </div>
            </form>
            </div>
        </div>
